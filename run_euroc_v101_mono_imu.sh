...
RESULT_DIR="${RESULT_DIR:-${REPO_ROOT}/results/euroc_v101_mono_imu}"
RUN_NAME="${RUN_NAME:-V101_mono_imu}"

EXE="${REPO_ROOT}/Examples/Monocular-Inertial/mono_inertial_euroc"
VOCAB="${REPO_ROOT}/Vocabulary/ORBvoc.txt"
SETTINGS="${REPO_ROOT}/Examples/Monocular-Inertial/EuRoC.yaml"
TIMESTAMPS="${REPO_ROOT}/Examples/Monocular-Inertial/EuRoC_TimeStamps/V101.txt"
